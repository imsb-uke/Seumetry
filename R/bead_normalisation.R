...
#'
#' Applies a bead normalisation on raw intensities (counts layer) of active Seurat assay using CATALYST::normCytof. A Seurat object is returned with a new assay "beadnorm" and 2 new meta.data columns for beads and potential bead/cell doublets. For details how this normalization works, please refer to https://www.bioconductor.org/packages/release/bioc/html/CATALYST.html.
#'
...
bead_norm <- function(seu,
    ...
    sce <- convert_seurat(seu, "SCE", layer = "counts")
    assay(sce, "data") <- counts(convert_seurat(seu, "SCE", layer = "data"))
